...
export const PROJECTS_DATA: Project[] = [
  {
    ...
    category: 'Full Stack',
    description: 'A tech NGO\'s digital brochure and web platform showcasing educational programs, student achievements, and community initiatives.',
    longDescription: 'Designed and developed for NIBCODE Foundation to present their technical web development curriculum and client services. Built with responsive styling, glassmorphic layout, and interactive course breakdowns.',
  ...
  },
  {
    ...
    category: 'Full Stack',
    description: 'An online store custom-built for a client utilizing Shopify technology for seamless product catalog management and shopping cart checkout.',
    longDescription: 'Crafted for Skilzz Stores to deliver a friction-free online shopping experience for customers. Features customized Shopify templates, product inventory cataloging, secure checkout workflows, and responsive styling.',
  ...
  },
  {
    ...
    category: 'Full Stack',
    description: 'A real estate platform built for a client, for advertising and discovering residential and commercial properties.',
    longDescription: 'A comprehensive real estate web application enabling property agents and buyers to list, discover, and inquire about real estate offerings with location filters, detail views, and contact channels.',
  ...
  },
  {
    ...
    category: 'Frontend',
    description: 'A video game discovery hub for exploring interesting games, release dates, ratings, and genre collections.',
    longDescription: 'Built with React and TypeScript, My-GameHub connects to gaming APIs to present rich game cards, metacritic scores, search queries, and genre selection with clean state management.',
  ...
  },
  {
    ...
    category: 'Frontend',
    description: 'A mock Single Page Application (SPA) designed for simulated monetary deposits, withdrawals, and balance history tracking.',
    longDescription: 'Developed using ReactJS and state management to simulate digital banking workflows. Allows users to test account balances, perform mock transaction deposits/withdrawals, and view history ledgers.',
  ...
  },
  {
    ...
    category: 'Full Stack',
    description: 'An AI chatbot web application for interactive conversational assistance and prompt responses.',
    longDescription: 'Sharp-GPT provides an intuitive user interface for conversing with artificial intelligence models, generating code assistance, writing help, and saving prompt threads.',
